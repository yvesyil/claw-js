...
cl_int openclSetupContextAndCommandQueue(cl_device_id *device_id,
                                         cl_context *ctx,
...
cl_int openclSetupProgram(cl_context ctx,
                          cl_program *prog,
...
cl_int openclSetupBuffersAndKernel(cl_context ctx,
